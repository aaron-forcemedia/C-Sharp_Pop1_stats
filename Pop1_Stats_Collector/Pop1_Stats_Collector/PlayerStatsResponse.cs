namespace Pop1_Stats_Collector
{
    ...
    public partial class PlayerProfile
    {
        ...
        public AdCampaignAttribution[] AdCampaignAttributions { get; set; }
        ...
        public ContactEmailAddress[] ContactEmailAddresses { get; set; }
        ...
        public string[] ExperimentVariants { get; set; }

        [JsonProperty("lastLogin")]
        public DateTimeOffset LastLogin { get; set; }

        [JsonProperty("linkedAccounts")]
        public LinkedAccount[] LinkedAccounts { get; set; }
        ...
        public PushNotificationRegistration[] PushNotificationRegistrations { get; set; }
